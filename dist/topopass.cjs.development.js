...
var hdnode = require('@ethersproject/hdnode');
var CryptoJS = _interopDefault(require('crypto-js'));

var NETWORK_TOPO = function NETWORK_TOPO(network, name) {
  this.network = network;
  this.name = name;
  this.rpc = new providers.JsonRpcProvider(network);
  this.provider = new ethers.ethers.providers.JsonRpcProvider(network);
};
...
var WALLET_TOPO = /*#__PURE__*/function () {
                    ...
                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return ethers.Wallet.fromMnemonic(res.phrase, res.path);
                          case 2:
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                try {
                  ...
                  entropy = random.randomBytes(16);
                  mnemonic = hdnode.entropyToMnemonic(entropy, options.locale);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return ethers.Wallet.fromMnemonic(seedPhrase, options.path, options.locale);
              case 3:
  ...
  _proto.GET_CONTRACT = function GET_CONTRACT(address) {
    ...
    // The Contract object
    var contract = new ethers.Contract(address, daiAbi, this.network.provider);
    return contract;
  };
...
exports.NETWORK_TOPO = NETWORK_TOPO;
exports.WALLET_TOPO = WALLET_TOPO;
//# sourceMappingURL=topopass.cjs.development.js.map
